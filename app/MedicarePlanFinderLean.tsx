...
import PlanFullBenefitsModal from './PlanFullBenefitsModal'
...
function BenefitRecap({ plan, onClose }: { plan: MedicarePlan; onClose: () => void }) {
  return <PlanFullBenefitsModal plan={plan} onClose={onClose} />
}
